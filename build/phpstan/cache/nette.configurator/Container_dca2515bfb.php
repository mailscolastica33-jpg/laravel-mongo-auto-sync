...
class Container_dca2515bfb extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_dca2515bfb $container)
			{
	...
	public function createServiceContainer(): Container_dca2515bfb
	{
		return $this;
	}
